...
function te_base(word: any) {
  ...
  if (word.category === "ichidan") {
    ...
    if (["問う", "訪う", "請う", "乞う", "恋う"].indexOf(word.slug) > -1) {
      return "うて";
    } else if (
      ["る", "つ", "う"].indexOf(ending) > -1 ||
      word.slug === "行く"
    ) {
      return "って";
...
function ta_base(word: any) {
  ...
  if (word.category === "ichidan") {
    ...
    if (["る", "つ", "う"].indexOf(ending) > -1 || word.slug === "行く") {
      return "った";
    } else if (["ぶ", "む", "ぬ"].indexOf(ending) > -1) {
      return "んだ";
    } else if (ending === "ぐ") {
...
const verb = function (word: any) {
  const root = get_root(word),
    a_stem = {
...
const irregular_verb = {
  ...
  suru: function (word: any) {
    const kanji = word.slug.substring(0, word.slug.length - 2);
    const kana = word.readings[0].substring(0, word.readings[0].length - 2);
    return {
...
const english_verb = function (verb: any) {
  if (verb.infinitive.split(" ")[1] !== "be") {
    return {
      ...
      indicative: {
        positive: [
          verb.conj.indicative.positive,
          "will " + verb.conj.indicative.positive,
        ],
        negative: [
          verb.conj.indicative.negative,
          "won't " + verb.conj.indicative.positive,
        ],
      },
      past_indicative: {
      ...
      presumptive: {
        positive: [
          "probably " + verb.conj.indicative.positive,
          "will probably " + verb.conj.indicative.positive,
        ],
        negative: [
          "probably don't " + verb.conj.indicative.positive,
          "probably won't " + verb.conj.indicative.positive,
        ],
      },
      past_presumptive: {
        positive: [
          "probably " + verb.conj.past_indicative.positive,
          "probably have " + verb.conj.participle,
          "probably had " + verb.conj.participle,
        ],
        negative: [
          "probably didn't " + verb.conj.indicative.positive,
          "probably haven't " + verb.conj.participle,
          "probably hadn't " + verb.conj.participle,
        ],
      },
      progressive: {
      ...
      volitional: {
        positive: [
          "intend to " + verb.conj.indicative.positive,
          "will " + verb.conj.indicative.positive,
          "let's " + verb.conj.indicative.positive,
        ],
        negative: [
          "don't intend to " + verb.conj.indicative.positive,
          "won't " + verb.conj.indicative.positive,
          "let's not " + verb.conj.indicative.positive,
        ],
      },
      potential: {
        positive: [
          "can " + verb.conj.indicative.positive,
          "are able " + verb.infinitive,
        ],
        negative: [
          "can't " + verb.conj.indicative.positive,
          "aren't able " + verb.infinitive,
        ],
      },
      causative: {
        positive: [
          "make X " + verb.conj.indicative.positive,
          "let X " + verb.conj.indicative.positive,
        ],
        negative: [
          "don't make X " + verb.conj.indicative.positive,
          "don't let X " + verb.conj.indicative.positive,
        ],
      },
      passive: {
        positive: [
          "are " + verb.conj.participle,
          "will be " + verb.conj.participle,
        ],
        negative: [
          "aren't " + verb.conj.participle,
          "won't be " + verb.conj.participle,
        ],
      },
      provisional: {
      ...
      conditional: {
        positive: [
          "if X " + verb.conj.indicative.positive,
          "when X " + verb.conj.indicative.positive,
        ],
        negative: [
          "if X don't " + verb.conj.indicative.positive,
          "when X don't " + verb.conj.indicative.positive,
        ],
      },
      imperative: {
    ...
    const stem = verb.infinitive.split(" ").splice(1).join(" ");
    return {
      participle: verb.conj.participle,
      gerund: verb.conj.gerund,
      indicative: {
      ...
      presumptive: {
        ...
        negative: [
          "probably " + verb.conj.indicative.negative,
          "probably won't " + stem,
        ],
      },
      past_presumptive: {
        ...
        negative: [
          "probably " + verb.conj.past_indicative.negative,
          "probably haven't " + verb.conj.participle,
          "probably hadn't " + verb.conj.participle,
        ],
      },
      ...
      passive: {
        positive: [
          "suffer X " + verb.conj.gerund,
          "will suffer X " + verb.conj.gerund,
        ],
        negative: [
          "don't suffer X " + verb.conj.gerund,
          "won't suffer X " + verb.conj.gerund,
        ],
      },
      provisional: {
        positive: ["if X " + verb.conj.indicative.positive],
      ...
      conditional: {
        positive: [
          "if X were " + verb.infinitive,
          "when X " + verb.conj.indicative.positive,
        ],
        negative: [
          "if X weren't " + verb.infinitive,
          "when X " + verb.conj.indicative.negative,
        ],
      },
      imperative: {
        positive: [stem],
...
const i_adjective = function (word: any) {
  ...
  const last_sound = stem.kana[stem.kana.length - 1];
  const kanji_stem_minus_one =
    stem.kanji.substring(0, stem.kanji.length - 1).length > 0
      ? stem.kanji.substring(0, stem.kanji.length - 1)
      : stem.kanji;
  if (a_sounds.indexOf(last_sound) > -1) {
    gstem = {
      kanji:
        kanji_stem_minus_one + o_sounds[a_sounds.indexOf(last_sound)] + "う",
      kana:
        stem.kana.substring(0, stem.kana.length - 1) +
        o_sounds[a_sounds.indexOf(last_sound)] +
        "う",
    };
    ...
    u_sounds.indexOf(last_sound) > -1 ||
    o_sounds.indexOf(last_sound) > -1
  ) {
    gstem = {
      kanji: stem.kanji + "う",
      kana: stem.kana + "う",
  ...
  return {
    indicative: {
      ...
      polite: {
        ...
        negative: {
          kanji: stem.kanji + "くないです",
          kana: stem.kana + "くないです",
        },
      },
    },
    past_indicative: {
      plain: {
        ...
        negative: {
          kanji: stem.kanji + "くなかった",
          kana: stem.kana + "くなかった",
        },
      },
      polite: {
        positive: {
          kanji: stem.kanji + "かったです",
          kana: stem.kana + "かったです",
        },
        negative: {
          kanji: stem.kanji + "くなかったです",
          kana: stem.kana + "くなかったです",
        },
      },
    },
    presumptive: {
      plain: {
        ...
        negative: {
          kanji: stem.kanji + "くないだろう",
          kana: stem.kana + "くないだろう",
        },
      },
      polite: {
        positive: {
        ...
        negative: {
          kanji: stem.kanji + "くないでしょう",
          kana: stem.kana + "くないでしょう",
        },
      },
    },
    past_presumptive: {
      plain: {
        positive: {
          kanji: stem.kanji + "かっただろう",
          kana: stem.kana + "かっただろう",
        },
        negative: {
          kanji: stem.kanji + "くなかっただろう",
          kana: stem.kana + "くなかっただろう",
        },
      },
      polite: {
        positive: {
          kanji: stem.kanji + "かったでしょう",
          kana: stem.kana + "かったでしょう",
        },
        negative: {
          kanji: stem.kanji + "くなかったでしょう",
          kana: stem.kana + "くなかったでしょう",
        },
      },
    },
    provisional: {
      plain: {
        ...
        negative: {
          kanji: stem.kanji + "くなければ",
          kana: stem.kana + "くなければ",
        },
      },
    },
    continuative: {
      plain: {
        ...
        negative: {
          kanji: stem.kanji + "くなくて",
          kana: stem.kana + "くなくて",
        },
      },
      polite: {
        positive: {
          kanji: stem.kanji + "くありまして",
          kana: stem.kana + "くありまして",
        },
        negative: {
          kanji: stem.kanji + "くありませんで",
          kana: stem.kana + "くありませんで",
        },
      },
    },
    conditional: {
      plain: {
        positive: {
          kanji: stem.kanji + "かったら",
          kana: stem.kana + "かったら",
        },
        negative: {
          kanji: stem.kanji + "くなかったら",
          kana: stem.kana + "くなかったら",
        },
      },
      polite: {
        positive: {
          kanji: gstem.kanji + "ございましたら",
          kana: gstem.kana + "ございましたら",
        },
        negative: {
          kanji: stem.kanji + "くありませんでしたら",
          kana: stem.kana + "くありませんでしたら",
        },
      },
    },
...
const na_adjective = function (word: any) {
  return {
    indicative: {
      plain: {
...
const english_adjective = function (word: any) {
  return {
    indicative: {
      positive: ["are " + word],
